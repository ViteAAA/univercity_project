...
async function fetchReviews() {
    try {
        ...
        return backendReviews.map(review => ({
            ...
            type: review.type,
            avatar: review.avatar || "url('../images/svg/example.svg')",
            title: review.title,
            text: review.text
        }));
    } catch (error) {
...
// Создаем и экспортируем промис, который разрешится в массив отзывов
export const reviews = fetchReviews();
